...
let apiKey = "YOUR_API_KEY_HERE"; // Replace sk-your-actual-api-key-here
let quizQuestions = [];
...
async function askAI(prompt) {
  if (!apiKey || apiKey === "YOUR_API_KEY_HERE") {
    return "Error: API key not configured. Please edit background.js and add your DeepSeek API key.";
  }
